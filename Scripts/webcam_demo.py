...
caffe_root = '/home/wj/caffe-segnet-cudnn5'
...
cap = cv2.VideoCapture('/home/wj/SegNet-Tutorial/Scripts/demo.mp4') # Change this to your webcam ID, or file name for your video file
...
while rval:
	...
	start = time.time()
	temp = np.zeros(label_colours[0][1].shape, dtype=np.uint8)
	temp = label_colours[0][5]
	...
	label_colours[0][5] = label_colours[0][4]
